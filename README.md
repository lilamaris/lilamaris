...
![Skills](https://skills.syvixor.com/api/icons?i=svelte,nextjs,reactjs,tailwindcss,ts,prisma,postgresql,python,fastapi,cpp,neovim,git,pnpm,arch,alacritty&perline=8)
